    ...
    <main className="mx-auto max-w-[820px] bg-white p-10 text-black print:p-0">
      ...
      <header className="mb-6 border-b-2 border-black pb-4">
        ...
        <p className="mt-1 text-xs">
          Printed {printedAt} · Reproducible at sebenzasa.com/gov/brief ·
      ...
      <section className="page-break-inside-avoid mb-8">
        ...
        <p className="mt-2 text-xs italic">
          ...
          placement_velocity. Formula published at sebenzasa.com/privacy.
        </p>
      </section>
      ...
      <section className="page-break-inside-avoid mb-8">
        ...
        <p className="mb-2 text-xs italic">
          ...
          by SA citizens (local_supply_ratio ≥ 1.0). Cells where local-
          hiring incentive policy lands without harming employers who
          genuinely can&rsquo;t find local talent.
        </p>
      ...
      <footer className="mt-12 border-t-2 border-black pt-3 text-xs">
        <p>
          ...
          briefing at <strong>sebenzasa.com/gov</strong>. Methodology +
          formula definitions at sebenzasa.com/privacy. Sebenza is
          policy intelligence, not a regulatory enforcement tool
          numbers here are inputs to decisions, not decisions
          themselves.
        </p>
      </footer>
