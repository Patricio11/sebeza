// Sebenza LinkedIn asset renderer (the 2256x382 company banner).
// Run from the repo root: node docs/social_media/linkedin/assets/src/render.mjs
...
const CARDS = [{ template: "banner-linkedin.html", out: "banner-linkedin.png", w: 2256, h: 382 }];
