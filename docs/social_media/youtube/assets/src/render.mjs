// Sebenza YouTube asset renderer (the 2560x1440 channel banner).
// Run from the repo root: node docs/social_media/youtube/assets/src/render.mjs
...
const CARDS = [{ template: "banner-youtube.html", out: "banner-youtube.png", w: 2560, h: 1440 }];
